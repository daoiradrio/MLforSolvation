...
def build_model(cfg, solvent, qa_mean, qa_var, checkpoint_path, device):
    ...
    if use_q_heads:
        from mlqsolv_riniker.model.networks.GNN_direct import GNN_direct_heads as Model
    else:
        from mlqsolv_riniker.model.networks.GNN_direct import GNN_direct as Model
